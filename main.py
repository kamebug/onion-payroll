            ...
            _item("Saída Antecipada", "Preencha só a Saída (HH:MM)",
                  "残業 = 0 se saiu antes do limiar. Cálculo pelo tempo real."),
                    ...
                    _item("Saída Antecipada — Célula 🩵 Verde-azulado",
                          "Selecione no dropdown e preencha o horário de saída real",
                          "Hora extra = 0 se saiu antes do limite configurado."),
                    _item("Abono / Vale do dia (¥)", "Campo numérico no modal de ponto",
                          "Valor de abono ou vale recebido naquele dia. Acumulado separadamente no holerite."),
